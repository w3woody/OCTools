...
ExampleStack Example::processReduction(int16_t rule)
{
...
int32_t Example::actionForState(int32_t state, int32_t token)
{
	size_t min,max,mid;
...
int32_t Example::gotoForState(int32_t state, int32_t token)
{
	size_t min,max,mid;
...
void Example::error(int32_t line, int32_t col, std::string fname, int32_t errCode, std::map<std::string,std::string> &map)
{
...
void Example::errorWithCode(int32_t code, std::map<std::string,std::string> &data)
{
...
void Example::errorWithCode(int32_t code)
{
	std::map<std::string,std::string> empty;
	errorWithCode(code, empty);
}

void Example::errorOK()
{
	errorCount = 0;
}

std::string Example::tokenToString(uint32_t token)
{
...
bool Example::reduceByAction(int16_t action)
{
	...
	ExampleStack state = processReduction(action);
